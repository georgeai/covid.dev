...
#echo "To: {$to_sites}/{$shorty}"
  ...
  while true; do
    ...
    case $yn in
        [Yy]* ) cd ../$to_sites_i; git commit -m "From: $from_site/{$shorty} / To: {$to_sites}/{$shorty}"; git push -u origin master ; cd ../$from_site ; break ;;
        [Nn]* ) cd ../$to_sites_i; git commit -m "From: $from_site/{$shorty} / To: {$to_sites}/{$shorty} [skip ci]" ; git push -u origin master ; cd ../$from_site ; break ;;
