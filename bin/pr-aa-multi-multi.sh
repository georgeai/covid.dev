...
echo "--- SUMMARY ---"
echo
echo "Copy multiple 1y relative urls and notes -> multiple 1y sites"
echo "---"
...
do
  ...
  url="https://$from_site/${rel_note_url:1}"
...
do
  ...
  #echo
  #echo ">> rsync files $shorty_file_path $note_file_path ../$to_sites_i/"
  #echo
