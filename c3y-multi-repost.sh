...
do
  ...
  # Publish immediately -- no [skip ci]
  cd ../$to_sites_i; git add $note_file_path $shorty_file_path ; git commit -m "repost 1y note from $from_site : $url and repost 1y shorty: $shorty_url"; git push -u origin master
