...
while true; do
    ...
    case $yn in
        [Yy]* ) git add $filename $urls_filename; git commit -m "new 1y message: $url -> $note and new 1y shorty: $shorty_url"; git push -u origin master ; break ;;
        [Nn]* ) git add $filename $urls_filename; git commit -m "new 1y message: $url -> $note and new 1y shorty: $shorty_url [skip ci]" ; git push -u origin master ; break ;;
